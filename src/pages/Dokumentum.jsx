    ...
    <div className="space-y-6 pb-12 animate-fade-in text-white">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-slate-850 pb-5">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Húzza be a NAV leveleket vagy számlákat a point-and-click OCR elemzéshez és IBAN csalásszűréshez</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="lg:col-span-6 flex flex-col bg-slate-900/30 rounded-2xl border border-slate-850 p-6 space-y-4">
          <div className="flex justify-between items-center bg-slate-950/40 p-3.5 rounded-xl border border-slate-850">
            <span className="text-xs font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2">
              📂 Scanned Invoice Preview
            </span>
            <div className="flex items-center gap-2">
              <button onClick={handleZoomOut} className="p-2 rounded-lg hover:bg-slate-800 text-slate-400 hover:text-white transition-colors cursor-pointer">
                <ZoomOut className="w-4 h-4" />
              </button>
              <button onClick={handleZoomIn} className="p-2 rounded-lg hover:bg-slate-800 text-slate-400 hover:text-white transition-colors cursor-pointer">
                <ZoomIn className="w-4 h-4" />
              </button>
              <button onClick={handleRotate} className="p-2 rounded-lg hover:bg-slate-800 text-slate-400 hover:text-white transition-colors cursor-pointer">
          ...
          <div className="bg-slate-950/60 rounded-2xl border border-slate-850/80 p-8 flex items-center justify-center min-h-[460px] overflow-hidden relative">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <button 
                    ...
                    className="font-bold text-slate-900 hover:bg-blue-100 border border-blue-500/20 border-dashed px-1.5 py-0.5 rounded text-left transition-colors"
                  >
                ...
                <div>
                  ...
                  <button 
                    ...
                    className="font-bold text-slate-900 hover:bg-red-100 border border-red-500/30 border-dashed px-1.5 py-0.5 rounded text-left transition-colors"
                  >
              ...
              <div className="flex justify-between items-center pt-4 border-t">
                ...
                <button
                  ...
                  className="font-extrabold text-slate-900 text-sm hover:bg-blue-100 border border-blue-500/20 border-dashed px-1.5 py-0.5 rounded transition-colors"
                >
                  1.270.000 Ft
                </button>
              </div>
        ...
        <div className="lg:col-span-6 flex flex-col bg-slate-900/30 rounded-2xl border border-slate-850 p-6 space-y-4">
          ...
          <div className="flex border-b border-slate-800">
            <button
              ...
              className={`pb-3 px-4 text-xs font-semibold uppercase tracking-wider transition-all border-b-2 cursor-pointer ${
                activeTab === 'details' ? 'border-[#00F872] text-[#00F872]' : 'border-transparent text-slate-500 hover:text-white'
              }`}
            >
              Alapadatok
            </button>
            <button
              ...
              className={`pb-3 px-4 text-xs font-semibold uppercase tracking-wider transition-all border-b-2 cursor-pointer ${
                activeTab === 'items' ? 'border-[#00F872] text-[#00F872]' : 'border-transparent text-slate-500 hover:text-white'
              }`}
            >
              Tételek Rácsa
            </button>
            <button
              ...
              className={`pb-3 px-4 text-xs font-semibold uppercase tracking-wider transition-all border-b-2 cursor-pointer ${
                activeTab === 'ai' ? 'border-[#00F872] text-[#00F872]' : 'border-transparent text-slate-500 hover:text-white'
              }`}
            >
              AI Levelelemző
            </button>
          ...
          {activeTab === 'details' && (
            <div className="space-y-4 animate-fade-in flex-1">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1.5">Küldő Partner Neve</label>
                  <input
                    type="text"
                    ...
                    className={`w-full bg-slate-950 border rounded-xl px-4 py-3 text-xs text-white focus:outline-none transition-colors ${
                      activeField === 'partnerName' ? 'border-[#00F872]' : 'border-slate-800'
                    }`}
                  />
                </div>
                
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1.5">Számlaszám</label>
                  <input
                    type="text"
                    ...
                    className={`w-full bg-slate-950 border rounded-xl px-4 py-3 text-xs text-white focus:outline-none transition-colors ${
                      activeField === 'invoiceNumber' ? 'border-[#00F872]' : 'border-slate-800'
                    }`}
                  />
                </div>
              </div>
              ...
              <div>
                <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1.5">Fogadó IBAN Számlaszám</label>
                <input
                  type="text"
                  ...
                  className={`w-full bg-slate-950 border rounded-xl px-4 py-3 text-xs text-white focus:outline-none transition-colors ${
                    activeField === 'iban' ? 'border-[#00F872]' : 'border-slate-800'
                  }`}
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1.5">Számla Kelte</label>
                  <input
                    type="date"
                ...
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1.5">Összesen (Ft)</label>
                  <input
                    type="number"
                    ...
                    className={`w-full bg-slate-950 border rounded-xl px-4 py-3 text-xs text-white focus:outline-none transition-colors ${
                      activeField === 'total' ? 'border-[#00F872]' : 'border-slate-800'
                    }`}
                  />
                </div>
              </div>
          ...
          {activeTab === 'items' && (
            <div className="space-y-4 animate-fade-in flex-1">
              ...
              <div className="bg-slate-950/60 p-4 rounded-xl border border-slate-850 flex justify-between items-center text-xs">
                <span className="text-slate-500 font-bold uppercase">Line Items Összeg</span>
                <span className="text-white font-extrabold text-sm">{formatHuf(parsedTotal)}</span>
              </div>
            </div>
          )}
          ...
          {activeTab === 'ai' && (
            <div className="space-y-4 animate-fade-in flex-1">
              <div className="space-y-3">
                <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest">NAV levél szöveges bevitele</label>
                <textarea
                  value={docText}
                  onChange={(e) => setDocText(e.target.value)}
                  placeholder="Tisztelt Adózó! A Nemzeti Adó- és Vámhivatal..."
                  className="w-full h-32 p-4 bg-slate-950 border border-slate-850 rounded-xl text-xs text-white focus:outline-none focus:border-[#00F872] resize-none"
                />
              </div>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="text-xs bg-slate-950 border border-slate-850 hover:border-slate-700 text-slate-300 px-4 py-2.5 rounded-lg transition-colors cursor-pointer"
                >
              ...
              {result && (
                <div className="bg-slate-950/60 rounded-xl border border-slate-850 p-4 space-y-3 text-xs text-slate-300">
                  <div className="flex gap-2">
                    <Info className="w-4 h-4 text-blue-400 shrink-0 mt-0.5" />
                    <div>
                      <strong className="text-white">AI Összefoglaló:</strong>
                      <p className="text-slate-400 mt-1 leading-relaxed">{result.summary}</p>
                    </div>
                  </div>
                  <div className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#00F872] shrink-0 mt-0.5" />
                    <div>
                      <strong className="text-white">Kötelező Teendő:</strong>
                      <p className="text-slate-400 mt-1 leading-relaxed">{result.action}</p>
                    </div>
                  </div>
                </div>
              )}
